...
def plot_structure(poscar_path):
    ...
    parent_dir = os.path.dirname(script_dir)  # Go up one level from bader/
    ...
    try:
        ...
        # Set terminology for Bader analysis context
        z_cut_module.action_verb = "exclude"
        z_cut_module.action_past_tense = "excluded"
        z_cut_module.undo_description = "exclusion"
